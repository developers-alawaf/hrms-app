  ...
  try {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        html: `You have requested a password reset. Please reset your password: <a href="${process.env.FRONTEND_URL || 'http://localhost:5173'}/reset-password?token=${token}">Reset Password</a><br>This link expires in 7 days.`
      });
